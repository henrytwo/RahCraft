...
class Player:
    ...
    def detect(self):
        ...
        self.surrounding_block_data = []  # initially empty, will be filled later
    ...
    def collide(self, block_data):
        ...
        for block, block_type in block_data:  # for every block in the block list
        ...
        self.vy += self.gravity if self.vy + self.gravity < self.rect.h else 0  # gravity is applied to y-direction
